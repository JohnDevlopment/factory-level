...
var Collector: SceneTree = load("res://scripts/tools/Collector.gd").new()
# A list of directories to collect files from.
var directories := [
	"res://scripts/classes/nodes",
	"res://scripts/classes/resources",
	"res://scripts/classes/singletons",
	"res://scenes/autoloads"
]
